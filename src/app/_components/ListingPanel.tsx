...
export function ListingPanel({
  ...
  return (
    <aside className="pointer-events-auto fixed inset-0 z-[1350] flex flex-col overflow-auto bg-slate-950 text-slate-100 md:absolute md:inset-auto md:bottom-4 md:left-auto md:right-4 md:top-4 md:max-h-[calc(100dvh-2rem)] md:w-[390px] md:rounded-2xl md:border md:border-white/10 md:shadow-2xl">
