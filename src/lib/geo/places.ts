...
export const places: Place[] = [
  ...
  { id: "apgujeong", names: ["apgujeong", "압구정", "압구정동", "apgujeong station", "압구정역"], lat: 37.5262, lng: 127.0285, zoom: 16, radiusM: 800 },
  { id: "cheongdam", names: ["cheongdam", "청담", "청담동", "cheongdam station", "청담역"], lat: 37.5191, lng: 127.0517, zoom: 16, radiusM: 800 },
  ...
  { id: "gangdong", names: ["gangdong", "강동", "강동구", "gangdong-gu", "cheonho", "천호", "천호동"], lat: 37.53, lng: 127.1237, zoom: 14 },
  { id: "seongsu", names: ["seongsu", "성수", "seongdong", "성동"], lat: 37.544, lng: 127.056, zoom: 15 },
  { id: "konkuk", names: ["konkuk", "건대", "건대입구", "gundae", "화양동"], lat: 37.54, lng: 127.07, zoom: 15 },
  { id: "gwangjin", names: ["gwangjin", "광진", "광진구", "gwangjin-gu"], lat: 37.538, lng: 127.082, zoom: 14 },
  ...
  { id: "gasan-digital", names: ["gasan digital", "gasan digital complex", "gasan digital complex station", "gasan", "가산디지털", "가산디지털단지", "가산디지털단지역", "가산", "가산동"], lat: 37.4816, lng: 126.8828, zoom: 16, radiusM: 800 },
  { id: "geumcheon", names: ["geumcheon", "금천", "금천구", "geumcheon-gu"], lat: 37.4565, lng: 126.8954, zoom: 14 },
  ...
  { id: "sinchon", names: ["sinchon", "신촌", "신촌동", "이대", "ewha", "sinchon station", "신촌역"], lat: 37.559, lng: 126.937, zoom: 16, radiusM: 800 },
  { id: "seodaemun", names: ["seodaemun", "서대문", "서대문구", "seodaemun-gu"], lat: 37.5791, lng: 126.9368, zoom: 14 },
  ...
  { id: "jungnang", names: ["jungnang", "중랑", "중랑구", "jungnang-gu"], lat: 37.6063, lng: 127.093, zoom: 14 },
  { id: "nowon", names: ["nowon", "노원", "노원구", "nowon-gu"], lat: 37.654, lng: 127.056, zoom: 14 },
  { id: "seongbuk", names: ["seongbuk", "성북", "성북구", "seongbuk-gu", "gireum", "길음", "길음동"], lat: 37.5894, lng: 127.0167, zoom: 14 },
  { id: "gangbuk", names: ["gangbuk", "강북", "강북구", "gangbuk-gu", "mia", "미아", "suyu", "수유"], lat: 37.6395, lng: 127.0255, zoom: 14 },
  { id: "dobong", names: ["dobong", "도봉", "도봉구", "dobong-gu"], lat: 37.6686, lng: 127.0466, zoom: 14 },
  { id: "eunpyeong", names: ["eunpyeong", "은평", "은평구", "eunpyeong-gu", "yeonsinnae", "연신내"], lat: 37.6024, lng: 126.9293, zoom: 14 },
  ...
  { id: "hwagok", names: ["hwagok", "화곡", "화곡동", "hwagok station", "화곡역"], lat: 37.5417, lng: 126.8404, zoom: 16, radiusM: 800 },
  { id: "gayang", names: ["gayang", "가양", "가양동", "gayang station", "가양역"], lat: 37.5611, lng: 126.8551, zoom: 16, radiusM: 800 },
